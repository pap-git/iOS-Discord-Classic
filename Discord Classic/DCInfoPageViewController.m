...
- (void)viewDidLoad{
	[super viewDidLoad];
	self.creditLinks = [NSArray arrayWithObjects:@"https://twitter.com/trev3d", @"https://twitter.com/TyBrasher", @"https://github.com/InvoxiPlayGames", @"https://twitter.com/TorutheRedFox", @"https://github.com/ndcube", @"https://discord.com", nil];
}
