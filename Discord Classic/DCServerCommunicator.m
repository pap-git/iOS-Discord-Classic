...
- (void)showNonIntrusiveNotification;
...
- (void)showNonIntrusiveNotificationWithTitle:(NSString *)title {
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        self.notificationView.backgroundColor = [UIColor blackColor]; // Background color
        ...
        label.textColor = [UIColor grayColor]; // Text color
